...
export function SoftSkillsScreen({ userData: _userData, onNext, onResults }: SoftSkillsScreenProps) {
  ...
  const handleNext = () => {
    if (currentSkill < softSkills.length - 1) {
      ...
      // Converter skillRatings para o formato esperado
      const mappedResults = {
        comunicacao: skillRatings.communication || 50,
        lideranca: skillRatings.leadership || 50,
        trabalhoEquipe: skillRatings.teamwork || 50,
        resolucaoProblemas: skillRatings.problemSolving || 50,
        adaptabilidade: skillRatings.adaptability || 50,
        criatividade: skillRatings.creativity || 50,
        gestaoTempo: skillRatings.timeManagement || 50,
        negociacao: skillRatings.negotiation || 50
      }
          ...
          <div className="text-center space-y-6">
            ...
            <div className="stellar-border rounded-lg p-6">
              <h4 className="text-lg font-semibold text-white mb-4">
                Contextos de Aplicação em {_userData.specialty || 'Medicina'}:
              </h4>
